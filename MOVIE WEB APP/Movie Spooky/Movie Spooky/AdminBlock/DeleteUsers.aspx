<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteUsers.aspx.cs" Inherits="Movie_Spooky.AdminBlock.DeleteUsers" %>
...
<body>
    ...
    style="width:300px;height:300px">
      ...
      <asp:Button ID="Button1" runat="server" Text="" class="button" OnClick="Button1_Click"/>
        ...
        <h1  runat="server" id="h1" style="text-align:center;">Tap Bin to Delete User</h1>
